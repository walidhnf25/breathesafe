    ...
    <div class="login-container">
        ...
        <div class="right-side">
            ...
            <form action="{{ route('proseslogin') }}" method="POST">
                ...
                <button type="submit" class="btn btn-login btn-block mt-2 text-white">Login</button>
                <div class="text-center mt-3">
                    <small>Don't have an account? <a href="{{ route('register') }}" class="text-white font-weight-bold">Register</a></small>
                </div>
            </form>
        </div>
    </div>
